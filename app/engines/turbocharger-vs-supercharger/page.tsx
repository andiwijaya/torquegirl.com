...
export const metadata: Metadata = {
  ...
  openGraph: { type: "article", url: articleUrl, title: "Turbocharger vs Supercharger: What’s the Difference? | TorqueGirl", description: turboVsSuperchargerArticle.description, images: [{ url: turboVsSuperchargerArticle.heroImage, width: 1536, height: 1024, alt: turboVsSuperchargerArticle.heroAlt }] },
  twitter: { card: "summary_large_image", title: "Turbocharger vs Supercharger: What’s the Difference? | TorqueGirl", description: turboVsSuperchargerArticle.description, images: [turboVsSuperchargerArticle.heroImage] },
};
