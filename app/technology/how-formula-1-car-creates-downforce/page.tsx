...
export const metadata: Metadata = {
  ...
  openGraph: { type: "article", url: articleUrl, title: "How a Formula 1 Car Creates Downforce | TorqueGirl", description: formulaDownforceArticle.description, images: [{ url: formulaDownforceArticle.heroImage, width: 1536, height: 1024, alt: formulaDownforceArticle.heroAlt }] },
  twitter: { card: "summary_large_image", title: "How a Formula 1 Car Creates Downforce | TorqueGirl", description: formulaDownforceArticle.description, images: [formulaDownforceArticle.heroImage] },
};
  ...
  return <main className="site-shell article-shell">
    ...
    <article className="technical-article">
      ...
      <div className="article-layout"><aside className="article-rail"><span>01</span><span>AIRFLOW / LOAD / GRIP</span></aside><div className="article-body">
        ...
        <div className="article-sources"><strong>Sources &amp; technical context</strong><a href="https://www.formula1.com/en/latest/article/10-things-you-need-to-know-about-the-all-new-2022-f1-car.4OLg8DrXyzHzqHvT7d6x6D" rel="noreferrer">Formula 1: ground-effect floor and wake context</a><a href="https://www.formula1.com/en/latest/article/f1-glossary-f-j.2g6grJVxT6fDCDpSmgoCQX" rel="noreferrer">Formula 1 glossary: ground effect and grip</a><a href="https://www.fia.com/regulation/fia-formula-1-technical-regulations" rel="noreferrer">FIA Formula 1 technical regulations</a></div>
