  ...
  return <main className="site-shell article-shell">
    ...
    <article className="technical-article">
      ...
      <div className="article-layout"><aside className="article-rail"><span>01</span><span>TOOLS / COVERAGE / EVIDENCE</span></aside><div className="article-body">
        ...
        <p>For the fundamentals of ports, DTCs, live data, and clearing a warning light, read <Link className="inline-article-link" href="/technology/what-is-an-obd2-scanner">What Is an OBD2 Scanner?</Link>. For more TorqueGirl engineering explanations, explore <Link className="inline-article-link" href="/engines/turbocharger-vs-supercharger">turbochargers and superchargers</Link> or <Link className="inline-article-link" href="/technology/how-formula-1-car-creates-downforce">Formula 1 downforce</Link>.</p>
